...
public class LeftOutJoinTest {
    ...
    public static  void  main(String[] args) {
        ...
        JavaPairRDD<String,String> rdd2 = sc.parallelize(Arrays.asList("1","2","3","4","1"),2)
        ...
        JavaPairRDD<String,Tuple2<String,Optional<String>>> rdd3 = rdd1.leftOuterJoin(rdd2);

        rdd3.mapPartitionsWithIndex((Integer index,Iterator<Tuple2<String,Tuple2<String,Optional<String>>>> v)->{
